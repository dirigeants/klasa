...
class default_1 extends klasa_1.Language {
    constructor(store, directory, file) {
        ...
        this.language = {
            ...
            MONITOR_COMMAND_HANDLER_REPROMPT: (tag, error, time, abortTerm) => `${tag} | **${error}** | You have **${time}** seconds to respond to this prompt with a valid argument. Type **${abortTerm}** to abort this prompt.`,
            // eslint-disable-next-line max-len
            ...
            COMMAND_LOAD_ERROR: (type, name, error) => `❌ Failed to load ${type}: ${name}. Reason:${utils_1.codeBlock('js', error)}`,
            ...
            COMMAND_CONF_GUARDED: (name) => `${utils_1.toTitleCase(name)} may not be disabled.`,
