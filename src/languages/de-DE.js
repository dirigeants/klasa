...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			SETTING_GATEWAY_EXPECTS_GUILD: 'Der Parameter <Guild> erwartet entweder einen Server oder ein Serverobject.',
			...
			RESOLVER_INVALID_MEMBER: (name) => `${name} muss ein "user mention" oder eine gültige User-ID sein.`,
			RESOLVER_INVALID_CHANNEL: (name) => `${name} muss ein "channel mention" oder eine gültige Channel-ID sein.`,
			RESOLVER_INVALID_GUILD: (name) => `${name} muss eine gültige Server-ID sein.`,
			RESOLVER_INVALID_ROLE: (name) => `${name} muss ein "Rollen mention" oder eine gültige Rollen-ID sein.`,
			...
			COMMANDMESSAGE_MISSING_REQUIRED: (name) => `${name} ist ein ist ein zwingend erforderliches Argument.`,
			...
			INHIBITOR_RUNIN: (types) => `Dieser Befehl kan nur in ${types} channels ausgeführt werden`,
			INHIBITOR_RUNIN_NONE: (name) => `Der ${name} Befehl wurde nicht für die Benutzung in mindestens einem Channel aktiviert.`,
