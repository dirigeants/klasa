...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			SETTING_RESOLVER_INVALID_USER: 'Esta clave requiere o una ID o una instancia de \'User\'.',
			SETTING_RESOLVER_INVALID_CHANNEL: 'Esta clave requiere o una ID o una instancia de \'Channel\'.',
			SETTING_RESOLVER_INVALID_GUILD: 'Esta clave requiere o una ID o una instancia de \'Guild\'.',
			SETTING_RESOLVER_INVALID_ROLE: 'Esta clave requiere o una ID o una instancia de \'Role\'.',
			SETTING_RESOLVER_INVALID_BOOLEAN: 'Esta clave requiere un valor booleano (\'true\'/\'false\').',
			SETTING_RESOLVER_STRING_MAXMIN: (err) => `La longitud caracteres debe ser de ${err}.`,
			SETTING_RESOLVER_INVALID_INTEGER: 'Esta clave require un número entero.',
			SETTING_RESOLVER_INTEGER_MAXMIN: (err) => `El número entero debe ser ${err}.`,
			SETTING_RESOLVER_INVALID_FLOAT: 'Esta clave require un número.',
			SETTING_RESOLVER_FLOAT_MAXMIN: (err) => `El número debe ser ${err}.`,
			SETTING_RESOLVER_INVALID_URL: 'Esta clave require un enlace URL.',
			SETTING_RESOLVER_INVALID_COMMAND: 'Esta clave require un comando.',
			SETTING_RESOLVER_MINMAX_EXACTLY: (min) => `exactamente ${min}`,
			SETTING_RESOLVER_MINMAX_BOTH: (min, max) => `entre ${min} y ${max}`,
			SETTING_RESOLVER_MINMAX_MIN: (min) => `mayor que ${min}`,
			SETTING_RESOLVER_MINMAX_MAX: (max) => `menor que ${max}`,
			ARG_RESOLVER_INVALID_PIECE: (name, piece) => `${name} debe ser un nombre válido de ${piece}.`,
			ARG_RESOLVER_INVALID_MSG: (name) => `${name} debe ser una ID de mensaje válida.`,
			ARG_RESOLVER_INVALID_USER: (name) => `${name} debe ser una mención o una ID de usuario válida.`,
			ARG_RESOLVER_INVALID_MEMBER: (name) => `${name} debe ser una mención o una ID de usuario válida.`,
			ARG_RESOLVER_INVALID_CHANNEL: (name) => `${name} debe ser una mención o una ID de canal válida.`,
			ARG_RESOLVER_INVALID_GUILD: (name) => `${name} debe ser una ID válida de servidor.`,
			ARG_RESOLVER_INVALID_ROLE: (name) => `${name} debe ser una mención o una ID de rol válida.`,
			ARG_RESOLVER_INVALID_LITERAL: (name) => `Su opción no coincide con la siguiente posibilidad: ${name}`,
			ARG_RESOLVER_INVALID_BOOL: (name) => `${name} debe ser 'true' o 'false'.`,
			ARG_RESOLVER_INVALID_INT: (name) => `${name} debe ser un número entero.`,
			ARG_RESOLVER_INVALID_FLOAT: (name) => `${name} debe ser un número.`,
			ARG_RESOLVER_INVALID_URL: (name) => `${name} debe ser un enlace URL válido.`,
			ARG_RESOLVER_STRING_SUFFIX: ' carácteres',
			ARG_RESOLVER_MINMAX_EXACTLY: (name, min, suffix) => `${name} debe ser exactamente ${min}${suffix}.`,
			ARG_RESOLVER_MINMAX_BOTH: (name, min, max, suffix) => `${name} debe estar entre ${min} y ${max}${suffix}.`,
			ARG_RESOLVER_MINMAX_MIN: (name, min, suffix) => `${name} debe ser mayor que ${min}${suffix}.`,
			ARG_RESOLVER_MINMAX_MAX: (name, max, suffix) => `${name} debe ser menor que ${max}${suffix}.`,
