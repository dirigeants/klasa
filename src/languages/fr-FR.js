...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			SETTING_GATEWAY_EXPECTS_GUILD: 'Le paramètre <Guild> attend soit un id soit une instance de Guild.',
			...
			RESOLVER_INVALID_MSG: (name) => `${name} doit être un id de message valide.`,
			RESOLVER_INVALID_USER: (name) => `${name} doit être une mention ou un id d'utilisateur valide.`,
			RESOLVER_INVALID_MEMBER: (name) => `${name} doit être une mention ou un id d'utilisateur valide.`,
			RESOLVER_INVALID_CHANNEL: (name) => `${name} doit être un tag ou un id de salon valide.`,
			RESOLVER_INVALID_GUILD: (name) => `${name} doit être un id de serveur valide.`,
			RESOLVER_INVALID_ROLE: (name) => `${name} doit être une mention ou un id de rôle.`,
