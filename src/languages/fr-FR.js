...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			SETTING_RESOLVER_INVALID_CHANNEL: 'Cette clef attend un id ou une instance de Channel.',
			SETTING_RESOLVER_INVALID_GUILD: 'Cette clef attend un id de Guild.',
			...
			SETTING_RESOLVER_INTEGER_MAXMIN: (err) => `L'entier doit être ${err}.`,
			SETTING_RESOLVER_INVALID_FLOAT: 'Cette clef attend un Float.',
			SETTING_RESOLVER_FLOAT_MAXMIN: (err) => `Le float doit être ${err}.`,
			SETTING_RESOLVER_INVALID_URL: 'Cette clef attend une URL (Uniform Resource Locator).',
			SETTING_RESOLVER_INVALID_COMMAND: 'Cette clef attend une Command.',
			SETTING_RESOLVER_MINMAX_EXACTLY: (min) => `exactement ${min}`,
			...
			ARG_RESOLVER_INVALID_MSG: (name) => `${name} doit être un id de message valide.`,
			ARG_RESOLVER_INVALID_USER: (name) => `${name} doit être une mention ou un id d'utilisateur valide.`,
			ARG_RESOLVER_INVALID_MEMBER: (name) => `${name} doit être une mention ou un id d'utilisateur valide.`,
			ARG_RESOLVER_INVALID_CHANNEL: (name) => `${name} doit être un tag ou un id de salon valide.`,
			ARG_RESOLVER_INVALID_GUILD: (name) => `${name} doit être un id de serveur valide.`,
			ARG_RESOLVER_INVALID_ROLE: (name) => `${name} doit être une mention ou un id de rôle.`,
			ARG_RESOLVER_INVALID_LITERAL: (name) => `Votre option ne correspond pas à la seule possibilité: ${name}`,
			ARG_RESOLVER_INVALID_BOOL: (name) => `${name} doit être vrai ou faux.`,
			ARG_RESOLVER_INVALID_INT: (name) => `${name} doit être un entier.`,
			ARG_RESOLVER_INVALID_FLOAT: (name) => `${name} doit être un nombre valide.`,
			ARG_RESOLVER_INVALID_URL: (name) => `${name} doit être une url valide.`,
			ARG_RESOLVER_STRING_SUFFIX: ' caractères',
			ARG_RESOLVER_MINMAX_EXACTLY: (name, min, suffix) => `${name} doit être exactement ${min}${suffix}.`,
