	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_INFO: [
				...
				'• 🐇💨 Temps de chargement rapide avec le support de l\'ES8 (`async`/`await`)',
				'• 🎚🎛 Paramètres par serveur, qui peuvent être étendus avec votre propre code',
				'• 💬 Système de commandes personnalisable avec l\'analyse automatique de l\'usage ainsi qu\'un rechargement de modules faciles à utiliser',
