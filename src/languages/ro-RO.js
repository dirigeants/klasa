	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_INFO: [
				...
				'• 🐇💨 Lansare rapidă cu ajutorul la ES8 (`async`/`await`)',
				'• 🎚🎛 Setări pentru fiecare guild in parte care poate fi extins la propriul tău cod',
				'• 💬 Un sistem de comenzi care poate fi modificat cu utilizarea argumentelor fiind automată, reîncărcarea rapidă module',
