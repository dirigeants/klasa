...
export class Gateway extends GatewayStorage {
	...
	constructor(store, type, schema, provider) {
		 ...
		 */
		this.cache = (type in this.client) && this.client[type] instanceof Map ? this.client[type] : new Cache();
	 ...
	 * @since 0.0.1
	 * @param {(Array<string>|string)} [input=Array<string>] An object containing a id property, like @klasa/core objects, or a string
