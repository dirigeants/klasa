...
class RateLimitManager extends Collection {
	 ...
	 * @param {number} cooldown The amount of time in milliseconds for a RateLimit from this manager to reset
	 */
	...
	/**
	 * The amount of time in milliseconds for a RateLimit from this manager to reset
	 * @since 0.5.0
	 * @type {number}
	 */
	get cooldown() {
