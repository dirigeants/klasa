...
module.exports = class extends Monitor {
	...
	getPrefix(msg) {
		...
		if (this.regexPrefix.test(msg.content)) return { length: msg.content.match(this.regexPrefix) ? msg.content.match(this.regexPrefix)[0].length : null, regex: this.regexPrefix };
