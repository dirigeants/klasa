...
//#region Classes
	...
	export class KlasaClient extends Client {
		...
		public on(event: 'settingsUpdate', listener: (entry: Settings, changes: SettingsFolderUpdateResultEntry[]) => void): this;
		...
		public once(event: 'settingsUpdate', listener: (entry: Settings, changes: SettingsFolderUpdateResultEntry[]) => void): this;
...
//#region Pieces
	...
	export abstract class Provider extends Piece {
		...
		public abstract update<T = any>(table: string, entry: string, data: SettingsFolderUpdateResultEntry[] | [string, any][] | ObjectLiteral): Promise<T>;
		public abstract replace<T = any>(table: string, entry: string, data: SettingsFolderUpdateResultEntry[] | [string, any][] | ObjectLiteral): Promise<T>;
...
//#region Typedefs
	...
	export type Constants = {
		DEFAULTS: {
			...
			CONSOLE: Required<KlasaConsoleConfig>;
			QUERYBUILDER: {
				datatypes: {
